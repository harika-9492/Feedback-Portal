...
const FacultyDashboard = () => {
  ...
  const renderInsights = () => {
    ...
    <>
      ...
      {message.text && selectedSection === "dashboard" && (
      ...
      <Grid container spacing={3}>
        <Grid size={{ xs: 12, lg: 8 }}>
          <Card sx={{ borderRadius: 3, boxShadow: "var(--shadow-1)", height: "100%", minHeight: 430 }}>
            <CardContent>
                ...
                <Box sx={{ height: 360 }}>
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={responsesByFormData}>
                      ...
                      <Tooltip />
                      <Bar dataKey="responses" fill="#0ea5e9" radius={[6, 6, 0, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                </Box>
              )}
        ...
        <Grid size={{ xs: 12, lg: 4 }}>
          <Stack spacing={3}>
            <Card sx={{ borderRadius: 3, boxShadow: "var(--shadow-1)", minHeight: 205 }}>
              <CardContent>
                <Typography variant="h6" fontWeight={700} gutterBottom>
                  Form Status
                </Typography>
              ...
              <CardContent>
                ...
                {issueData.length === 0 ? (
                  <Typography variant="body2" color="text.secondary">
                    No issue trends yet. Collect a few responses to view improvement areas.
                  </Typography>
                ) : (
                  <Box sx={{ height: 250 }}>
                    <ResponsiveContainer width="100%" height="100%">
      ...
      <Grid container spacing={3} sx={{ mt: 0.5 }}>
        <Grid size={{ xs: 12, lg: 8 }}>
          <Card sx={{ borderRadius: 3, boxShadow: "var(--shadow-1)", minHeight: 320 }}>
            <CardContent>
              <Typography variant="h6" fontWeight={700} gutterBottom>
              ...
              {recentSuggestions.length === 0 ? (
                <Typography color="text.secondary">No written suggestions yet.</Typography>
              ) : (
                <Stack spacing={1.25}>
                  {recentSuggestions.map((suggestion, index) => (
                    <Paper key={`${index}-${suggestion.slice(0, 12)}`} sx={{ p: 1.5, borderRadius: 2 }}>
                      <Typography variant="body2" color="text.secondary">
                        Suggestion {index + 1}
                      </Typography>
          ...
          <Card sx={{ borderRadius: 3, boxShadow: "var(--shadow-1)", minHeight: 320 }}>
            <CardContent>
              ...
              <Stack spacing={1}>
                ...
                <Chip
                  label={
                    formStats.averageRating !== "N/A" && Number(formStats.averageRating) < 3.5
  ...
  const renderCreateForm = () => {
    return (
      <>
        ...
        {message.text && selectedSection === "forms" && (
          <Alert severity={message.type} sx={{ mb: 3 }}>
            {message.text}
          </Alert>
        )}
  ...
  return (
    ...
    >
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 4 }}>
        <Toolbar />
        {selectedSection === "dashboard" && renderInsights()}
        {selectedSection === "forms" && renderCreateForm()}
        {selectedSection === "yourForms" && renderYourForms()}
